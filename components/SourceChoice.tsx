    ...
    <section className="sb-card sb-choice" aria-labelledby="choice-title">
      <div className="sb-card__head">
        ...
        <p className="sb-card__note">
          You can switch either way later, and mix the two — a standard language
          plus a file of your own.
        </p>
      </div>
      ...
      <div className="sb-choice__options">
        ...
        >
          ...
          <span className="sb-choice__label">
            Start from the standard texts
          </span>
          <span className="sb-choice__note">
            {checking
              ...
              ? `${count} ${
                ...
                } ready to edit, nothing to upload.`
      ...
      {manifest === null ? (
        <p className="sb-hint">
          ...
          <code>node scripts/prepare-locales.mjs &lt;folder&gt;</code>. Until
          then, upload files instead.
        </p>
      ) : null}
    </section>
  );
